...
const loaderCartSimiler = document.getElementById("loaderCartSimiler");

// first singleImage Api
...
const api = async () => {
  ...
  <div class="description">
    ...
    <span class="ratingContent">20143 Ratings, ${
      result.rating.count
    } Reviews </span>
  </span>
...
api();
// second similer card Api

const SimilerApi = async (category) => {
  // second loader

  loaderCartSimiler.style.display = "block";
